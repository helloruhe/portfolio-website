                ...
                {SAMPLES.map((sample) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {hasLink ? (
                                <Button size="sm" as="a" href={sample.link} target="_blank" className="self-start">
                                    View
                                </Button>
                            ) : (
...
const SAMPLES = [
    {
        ...
        link: "https://drive.google.com/file/d/1w9HW5Jt7FhjfN4rdx-bHm0AqqMAzGG4R/view?usp=drive_link",
    },
    {
        title: "Character Sheet",
        description: "Sample character sheet showing backstory, dialogue barks, and personality.",
        image: "https://images.pexels.com/photos/2106194/pexels-photo-2106194.jpeg",
        tags: ["Narrative Design"],
        link: "https://drive.google.com/file/d/19DtS2YdVUbekrNYVDWilPPpdH48zqMRv/view?usp=drive_link",
    },
    {
        title: "Apotheosis",
        description: "An original screenplay I wrote that explores themes of human morality and desperation.<br /><br />In a world where humans are ruled by robots, a young woman travels with her dog to pay tribute to the mechanical God-Queen. What she offers determines her family's status and living conditions for ages to come. ",
    ...
    },
    {
        ...
        tags: ["Narrative Design"],
        link: "https://drive.google.com/file/d/1GoYG94gdMzygQOBxJ4vcCWZJQmUVsq0K/view?usp=drive_link",
    },
    {
        ...
        image: magic,
        tags: ["Game Design", "System Design"],
        link: "https://docs.google.com/spreadsheets/d/1cXFqsVwHekKiyrowB0PA5Ia4zvXuuxnBAoug8Iusrj8/edit?usp=drive_link",
    },
]