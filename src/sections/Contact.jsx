            ...
            <div className="mx-auto mt-8 max-w-5xl rounded-2xl border border-gold/20 bg-stone/40 p-8 shadow-xl shadow-black/40 backdrop-blur-xl">
                <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2 text-sm leading-relaxed text-parchment-dim">
                    ...
                    <form onSubmit={handleSubmit} className="glass rounded-2xl p-6 space-y-4">
                        <div className="grid gap-4 md:grid-cols-2">
                            <label className="flex flex-col gap-2 text-sm text-parchment-dim">
                                <span>Name</span>
                                <input
                                    name="from_name"
                                    type="text"
                        ...
                        <div className="flex flex-wrap items-center gap-4">
                            ...
                            {submitStatus?.type === "success" && (
                                <p className="text-sm text-gold">{submitStatus.message}</p>
                            )}
                            {submitStatus?.type === "error" && (
                                <p className="text-sm text-ember">{submitStatus.message}</p>
                            )}
                        </div>
                    </form>
                </div>
